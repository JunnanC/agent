...
Celery tasks intentionally contain no business facts. API transactions persist
facts plus Outbox records first; workers then dispatch external calls and
publish SSE events. This keeps runtime I/O outside the database transaction.
"""
